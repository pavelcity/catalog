...
@section('content')
		...
		<div class="pl-3">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0 p-0">
					...
					<li class="breadcrumb-item active" aria-current="page"><a href="{{ route('dashboard.news.home') }}">Новости</a></li>
	...
	<div class="card radius-5">
		<div class="card-body">
			...
			@if(true)
			<form action="{{ route('dashboard.news.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
				@csrf
			...
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				<li class="nav-item" role="presentation"> <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">НОВОСТИ</a>
				</li>
				...
				<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
							...
							<br>
								<div class="form-group">
									...
									<input class="form-control form-control-lg" id="title" name="title" type="text" placeholder="Заголовок заметки" value="{{ old('title') }}">
									@error('title')
								...
								<div class="form-group">
									@error('short')
										<p style="color:red;">{{ $message }}</p>
									@enderror
									<label for="short">Превью (анонс статьи)</label>
								...
								<div class="form-group">
									@error('descr')
										<p style="color:red;">{{ $message }}</p>
									@enderror
									<label for="descr">Текст статьи</label>
									<textarea id="descr" name="descr" class="form-control" rows="10" cols="3">{{ old('short') }}</textarea>
								</div>
