...
@section('title', 'Правила редактировать')
...
@section('content')
	...
	<div class="card radius-5">
		<div class="card-body">
			...
			@if(true)
			<form action="{{ route('dashboard.rules.update', $pravila->id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
				@csrf
			...
			<div class="tab-content p-3" id="myTabContent">
				...
				<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
							...
							<div class="form-group">
								...
								<input class="form-control form-control-lg" id="politictitle" name="politictitle" type="text" placeholder="Заголовок" value="{{ $pravila->politictitle }}">
								@error('politictitle')
							...
							<div class="form-group">
								...
								<textarea id="politic" name="politic" class="form-control" rows="10" cols="3">{{ $pravila->politic }}</textarea>
							</div>
							...
							<div class="form-group">
								...
								<input class="form-control form-control-lg" id="dostavkatitle" name="dostavkatitle" type="text" placeholder="Заголовок" value="{{ $pravila->dostavkatitle }}">
								@error('dostavkatitle')
									<p style="color:red;">{{ $message }}</p>
								@enderror
							</div>
							...
							<div class="form-group">
								...
								<textarea id="dostavka" name="dostavka" class="form-control" rows="10" cols="3">{{ $pravila->dostavka }}</textarea>
							</div>
							...
							<div class="form-group">
								...
								<input class="form-control form-control-lg" id="obmentitle" name="obmentitle" type="text" placeholder="Заголовок" value="{{ $pravila->obmentitle }}">
								@error('obmentitle')
									<p style="color:red;">{{ $message }}</p>
								@enderror
							</div>
							...
							<div class="form-group">
								...
								<textarea id="obmen" name="obmen" class="form-control" rows="10" cols="3">{{ $pravila->obmen }}</textarea>
							</div>
							...
							<div class="form-group">
								...
								<input class="form-control form-control-lg" id="pokupkatitle" name="pokupkatitle" type="text" placeholder="Заголовок" value="{{ $pravila->pokupkatitle }}">
								@error('pokupkatitle')
									<p style="color:red;">{{ $message }}</p>
								@enderror
							</div>
							...
							<div class="form-group">
								...
								<textarea id="pokupka" name="pokupka" class="form-control" rows="10" cols="3">{{ $pravila->pokupka }}</textarea>
							</div>
