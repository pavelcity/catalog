			...
			<div class="tab-content p-3" id="myTabContent">
				...
				<div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
					...
					<div class="mt-0">
						...
						<img src="{{ asset('uploads/not_image.jpg') }}" width="400" alt="" id="showPic1440">
					</div>
					...
					<div class="mt-0">
						...
						<img src="{{ asset('uploads/not_image.jpg') }}" width="400" alt="" id="showPic1366">
					</div>
					...
					<div class="mt-0">
						...
						<img src="{{ asset('uploads/not_image.jpg') }}" width="400" alt="" id="showPic1024">
					</div>
					...
					<div class="mt-0">
						...
						<img src="{{ asset('uploads/not_image.jpg') }}" width="400" alt="" id="showPic992">
					</div>
					...
					<div class="mt-0">
						...
						<img src="{{ asset('uploads/not_image.jpg') }}" width="400" alt="" id="showPic600">
					</div>
