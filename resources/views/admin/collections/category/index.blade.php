...
@section('title', 'Категории коллекций')
		...
		<div class="pl-3">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0 p-0">
					...
					<li class="breadcrumb-item"><a href="{{ route('dashboard.collections.home') }}">Коллекции</a>
					</li>
					<li class="breadcrumb-item active" aria-current="page">Категории коллекций</li>
				</ol>
			</nav>
		</div>
	</div>
...
<div class="card radius-5">
	<div class="card-body">
		...
		<div class="card-title">
			...
			<a href="{{ route('dashboard.collections.catcollection.create') }}" class="btn btn-secondary m-1 px-5 py-2">
