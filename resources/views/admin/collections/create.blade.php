...
@section('title', 'Коллекция создать')
...
@section('content')
	...
	<div class="card radius-5">
		<div class="card-body">
			...
			@if(true)
			<form action="{{ route('dashboard.collections.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
				@csrf
			...
			<div class="tab-content p-3" id="myTabContent">
				...
				<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
								...
								<div class="form-group">
									...
									<input class="form-control form-control-lg" id="title" name="size" type="text" placeholder="Размер" value="{{ old('size') }}">
									@error('size')
										<p style="color:red;">{{ $message }}</p>
									@enderror
								</div>
								...
								<div class="form-group">
									...
									<input class="form-control form-control-lg" id="title" name="color" type="text" placeholder="Цвет" value="{{ old('color') }}">
									@error('color')
										<p style="color:red;">{{ $message }}</p>
									@enderror
								</div>
								...
								<div class="form-group">
									...
									<input class="form-control form-control-lg" id="title" name="material" type="text" placeholder="Материал" value="{{ old('material') }}">
									@error('material')
										<p style="color:red;">{{ $message }}</p>
									@enderror
								</div>
								...
								<div class="form-group">
									...
									<input class="form-control form-control-lg" id="title" name="price" type="text" placeholder="Цена" value="{{ old('price') }}">
									@error('price')
										<p style="color:red;">{{ $message }}</p>
									@enderror
								</div>
