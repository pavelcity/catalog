...
@section('title', 'Коллекция токена создать')
...
@section('content')
	...
	<div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
		<div class="breadcrumb-title pr-3">Коллекция токена</div>
		<div class="pl-3">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0 p-0">
					<li class="breadcrumb-item"><a href="{{ route('dashboard.home') }}"><i class='bx bx-home-alt'></i></a>
					</li>
					<li class="breadcrumb-item active" aria-current="page"><a href="{{ route('dashboard.nft.token.home') }}">Коллекция токена</a></li>
	...
	<div class="card radius-5">
		<div class="card-body">
			...
			@if(true)
			<form action="{{ route('dashboard.nft.token.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
				@csrf
		
				<div class="card-title">
					<button type="submit" class="btn btn-primary m-1 px-5 py-2">Создать</button>
					<a href="{{ route('dashboard.nft.token.home') }}" class="btn btn-outline-primary m-1 px-5 py-2">Назад</a>
				</div>
				<hr/>
			...
			<div class="tab-content p-3" id="myTabContent">
				...
				<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
								...
								<div class="form-group">
									<label for="title">Название токен коллекции</label>
								...
								<div class="input-group mb-1 mt-0">
									...
									<div class="custom-file">
										<input type="file" name="pic370_1" class="custom-file-input " id="avatar" aria-describedby="avatar">
								...
								<div class="mt-0">
									<img src="{{ asset('uploads/not_image.jpg') }}" width="400" alt="" id="showPic2">
								</div>
								...
								<div class="input-group mb-5 mt-0">
									...
									<div class="custom-file">
										<input type="file" name="pic370_2" class="custom-file-input " id="avatar2" aria-describedby="avatar">
										<label class="custom-file-label" for="avatar">Выберите файл</label>
									</div>
				...
				<div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
					...
					<div class="mt-0">
						...
						<img src="{{ asset('uploads/not_image.jpg') }}" width="400" alt="" id="showPic375_2">
					</div>
					...
					<div class="mt-0">
						...
						<img src="{{ asset('uploads/not_image.jpg') }}" width="400" alt="" id="showPic375_3">
					</div>
					...
					<div class="mt-0">
						...
						<img src="{{ asset('uploads/not_image.jpg') }}" width="400" alt="" id="showPic375_4">
					</div>
					...
					<div class="mt-0">
						...
						<img src="{{ asset('uploads/not_image.jpg') }}" width="400" alt="" id="showPic375_5">
					</div>
