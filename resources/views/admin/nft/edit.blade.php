...
@section('title', 'NFT редактировать')
...
@section('content')
	...
	<div class="card radius-5">
		<div class="card-body">
			...
			@if(true)
			<form action="{{ route('dashboard.nft.update', $nft->id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
				@csrf
			...
			<div class="tab-content p-3" id="myTabContent">
				...
				<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
								...
								<div class="form-group">
									...
									<input class="form-control form-control-lg" id="title" name="title" type="text" placeholder="Название" value="{{ $nft->title }}">
									@error('title')
								...
								<div class="form-group">
									...
									<input class="form-control form-control-lg" id="price" name="price" type="text" placeholder="Цена" value="{{ $nft->price }}">
									@error('price')
										<p style="color:red;">{{ $message }}</p>
									@enderror
								</div>
								...
								<div class="form-group">
									...
									<textarea id="short" name="short" class="form-control" rows="10" cols="3">{{ $nft->short }}</textarea>
								</div>
								...
								<div class="form-group">
									...
									<textarea id="descr" name="descr" class="form-control" rows="10" cols="3">{{ $nft->descr }}</textarea>
								</div>
								...
								{{-- большая картинка  --}}
								<input type="hidden" name="old480_1" value="{{ $nft->pic480_1 ?? '' }}">
								<br>
								<label for="short">Картинка для превью</label>
								<div class="mt-0">
									<img src="{{ asset($nft->pic480_1 ?? 'uploads/not_image.jpg') }}" width="400" alt="" id="showPic">
								</div>
				...
				<div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab"> 
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="metaTitle" name="metaTitle" type="text" placeholder="meta title" value="{{ $nft->metaTitle }}">
						@error('metaTitle')
							<p style="color:red;">{{ $message }}</p>
						@enderror
					</div>
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="description" name="description" type="text" placeholder="meta description" value="{{ $nft->description }}">
						@error('description')
							<p style="color:red;">{{ $message }}</p>
						@enderror
					</div>
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="keywords" name="keywords" type="text" placeholder="meta keywords" value="{{ $nft->keywords }}">
						@error('keywords')
							<p style="color:red;">{{ $message }}</p>
						@enderror
					</div>
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="author" name="author" type="text" placeholder="meta author" value="{{ $nft->author }}">
						@error('author')
							<p style="color:red;">{{ $message }}</p>
						@enderror
					</div>
				...
				<div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="price1" name="price1" type="text" placeholder="Цена" value="{{ $nft->price1 }}">
						@error('price1')
							<p style="color:red;">{{ $message }}</p>
						@enderror
					</div>
					...
					{{-- маленькая картинка   --}}
					<br>
					<input type="hidden" name="old350_1" value="{{ $nft->pic350_1 ?? '' }}">
					<label for="short">1-я картинка</label>
					<div class="mt-0">
						
						<img src="{{ asset($nft->pic350_1 ?? 'uploads/not_image.jpg') }}" width="400" alt="" id="showPic400_2">
					</div>
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="price2" name="price2" type="text" placeholder="Цена" value="{{ $nft->price2 }}">
						@error('price2')
							<p style="color:red;">{{ $message }}</p>
						@enderror
					</div>
					...
					<br>
					<input type="hidden" name="old350_2" value="{{ $nft->pic350_2 ?? '' }}">
					<label for="short">2-я картинка</label>
					<div class="mt-0">
						
						<img src="{{ asset($nft->pic350_2 ?? 'uploads/not_image.jpg') }}" width="400" alt="" id="showPic400_3">
					</div>
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="price3" name="price3" type="text" placeholder="Цена" value="{{ $nft->price3 }}">
						@error('price3')
							<p style="color:red;">{{ $message }}</p>
						@enderror
					</div>
					...
					{{-- маленькая картинка 3-я картинка  --}}
					<br>
					<input type="hidden" name="old350_3" value="{{ $nft->pic350_3 ?? '' }}">
					<label for="short">3-я картинка</label>
					<div class="mt-0">
						
						<img src="{{ asset($nft->pic350_3 ?? 'uploads/not_image.jpg') }}" width="400" alt="" id="showPic400_4">
					</div>
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="price4" name="price4" type="text" placeholder="Цена" value="{{ $nft->price4 }}">
						@error('price4')
							<p style="color:red;">{{ $message }}</p>
						@enderror
					</div>
					...
					<br>
					<input type="hidden" name="old350_4" value="{{ $nft->pic350_4 ?? '' }}">
					<label for="short">4-я картинка</label>
					<div class="mt-0">
						
						<img src="{{ asset($nft->pic350_4 ?? 'uploads/not_image.jpg') }}" width="400" alt="" id="showPic400_5">
					</div>
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="price5" name="price5" type="text" placeholder="Цена" value="{{ $nft->price5 }}">
						@error('price5')
							<p style="color:red;">{{ $message }}</p>
						@enderror
					</div>
					...
					<br>
					<input type="hidden" name="old350_5" value="{{ $nft->pic350_5 ?? '' }}">
					<label for="short">5-я картинка</label>
					<div class="mt-0">
						
						<img src="{{ asset($nft->pic350_5 ?? 'uploads/not_image.jpg') }}" width="400" alt="" id="showPic400_6">
					</div>
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="price6" name="price6" type="text" placeholder="Цена" value="{{ $nft->price6 }}">
						@error('price6')
							<p style="color:red;">{{ $message }}</p>
						@enderror
					</div>
					...
					<br>
					<input type="hidden" name="old350_6" value="{{ $nft->pic350_6 ?? '' }}">
					<label for="short">6-я картинка</label>
					<div class="mt-0">
						
						<img src="{{ asset($nft->pic350_6 ?? 'uploads/not_image.jpg') }}" width="400" alt="" id="showPic400_7">
					</div>
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="price7" name="price7" type="text" placeholder="Цена" value="{{ $nft->price7 }}">
						@error('price7')
							<p style="color:red;">{{ $message }}</p>
						@enderror
					</div>
					...
					<br>
					<input type="hidden" name="old350_7" value="{{ $nft->pic350_7 ?? '' }}">
					<label for="short">7-я картинка</label>
					<div class="mt-0">
						
						<img src="{{ asset($nft->pic350_7 ?? 'uploads/not_image.jpg') }}" width="400" alt="" id="showPic400_8">
					</div>
				...
				<div class="tab-pane fade" id="opengraph" role="tabpanel" aria-labelledby="contact-tab">
					...
					<div class="mt-0">
						...
						<img src="{{ asset($nft->ogimg ?? 'uploads/not_image.jpg') }}" width="400" alt="" id="showPicogimg">
					</div>
				...
				<div class="tab-pane fade" id="schemaorg" role="tabpanel" aria-labelledby="contact-tab">
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="sschemaDescription" name="schemaDescription" type="text" placeholder="короткое описание статьи" value="{{ $nft->schemaDescription }}">
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="schemaAuthor" name="schemaAuthor" type="text" placeholder="автор статьи" value="{{ $nft->schemaAuthor }}">
						@error('schemaAuthor')
							<p style="color:red;">{{ $message }}</p>
						@enderror
					</div>
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="schemaPublisher" name="schemaPublisher" type="text" placeholder="название компании" value="{{ $nft->schemaPublisher }}">
