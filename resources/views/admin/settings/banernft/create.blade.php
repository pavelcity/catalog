...
@section('title', 'Банер nft создать')
...
@section('content')
		...
		<div class="pl-3">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0 p-0">
					...
					<li class="breadcrumb-item active" aria-current="page"><a href="{{ route('dashboard.settings.banernft.home') }}">Банер nft</a></li>
	...
	<div class="card radius-5">
		<div class="card-body">
			...
			@if(true)
			<form action="{{ route('dashboard.settings.banernft.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
				@csrf
			...
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				<li class="nav-item" role="presentation"> <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Банер nft (фото)</a>
				</li>
			...
			<div class="tab-content p-3" id="myTabContent">
				...
				<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
								...
								<br>
								<div class="form-group">
									<label for="link">Ссылка банера</label>
