...
@section('title', 'Подарочные наборы изменить')
...
@section('content')
	...
	<div class="card radius-5">
		<div class="card-body">
			...
			@if(true)
			<form action="{{ route('dashboard.settings.podarki.update', $gift->id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
				@csrf
			...
			<div class="tab-content p-3" id="myTabContent">
				...
				<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
								...
								<div class="form-group">
									...
									<input class="form-control form-control-lg" id="title" name="title" type="text" placeholder="Название" value="{{ $gift->title }}">
									@error('title')
								...
								<div class="form-group">
									...
									<input class="form-control form-control-lg" id="price" name="price" type="text" placeholder="Цена подарочного набора" value="{{ $gift->price }}">
									@error('price')
										<p style="color:red;">{{ $message }}</p>
									@enderror
								</div>
								...
								{{-- большая картинка 420px --}}
								<br>
								<input type="hidden" name="old420" value="{{ $gift->pic420 }}">
								<label for="short">Главная картинка (превью)</label>
								<div class="mt-0">
									<img src="{{ asset($gift->pic420 ?? 'uploads/not_image.jpg') }}" width="400" alt="" id="showPic">
								</div>
				...
				<div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
					...
					<br>
					<input type="hidden" name="old480" value="{{ $gift->pic480 }}">
					<label for="short">Картинка (для ширины - 480px)</label>
					<div class="mt-0">
						
						<img src="{{ asset($gift->pic480 ?? 'uploads/not_image.jpg') }}" width="400" alt="" id="showPic480">
					</div>
					...
					<br>
					<input type="hidden" name="old414" value="{{ $gift->pic414 }}">
					<label for="short">Картинка (для ширины - 414px)</label>
					<div class="mt-0">
						
						<img src="{{ asset($gift->pic414 ?? 'uploads/not_image.jpg') }}" width="400" alt="" id="showPic414">
					</div>
					...
					<br>
					<input type="hidden" name="old375" value="{{ $gift->pic375 }}">
					<label for="short">Картинка для iphone (для ширины - 375 px)</label>
					<div class="mt-0">
						
						<img src="{{ asset($gift->pic375 ?? 'uploads/not_image.jpg') }}" width="400" alt="" id="showPic375">
					</div>
