...
@section('title', 'Контакты редактировать')
...
@section('content')
	...
	<div class="card radius-5">
		<div class="card-body">
			...
			@if(true)
			<form action="{{ route('dashboard.contact.update', $contact->id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
				@csrf
			...
			<div class="tab-content p-3" id="myTabContent">
				...
				<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
							...
							<div class="form-group">
								...
								<input class="form-control form-control-lg" id="title" name="title" type="text" placeholder="Название" value="{{ $contact->title }}">
								@error('title')
							...
							<div class="form-group">
								...
								<input class="form-control form-control-lg" id="adres" name="adres" type="text" placeholder="Адрес" value="{{ $contact->adres }}">
								@error('adres')
									<p style="color:red;">{{ $message }}</p>
								@enderror
							</div>
							...
							<div class="form-group">
								...
								<input class="form-control form-control-lg" id="phone" name="phone" type="text" placeholder="Телефон" value="{{ $contact->phone }}">
								@error('phone')
									<p style="color:red;">{{ $message }}</p>
								@enderror
							</div>
							...
							<div class="form-group">
								...
								<input class="form-control form-control-lg" id="phoemaile" name="email" type="text" placeholder="email" value="{{ $contact->email }}">
								@error('email')
									<p style="color:red;">{{ $message }}</p>
								@enderror
							</div>
							...
							<div class="form-group">
								...
								<textarea id="map" name="map" class="form-control" rows="7" cols="3">{{ $contact->map }}</textarea>
								@error('email')
									<p style="color:red;">{{ $message }}</p>
								@enderror
							</div>
				...
				<div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab"> 
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="metaTitle" name="metaTitle" type="text" placeholder="meta title" value="{{ $contact->metaTitle }}">
						@error('metaTitle')
							<p style="color:red;">{{ $message }}</p>
						@enderror
					</div>
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="description" name="description" type="text" placeholder="meta description" value="{{ $contact->description }}">
						@error('description')
							<p style="color:red;">{{ $message }}</p>
						@enderror
					</div>
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="keywords" name="keywords" type="text" placeholder="meta keywords" value="{{ $contact->keywords }}">
						@error('keywords')
							<p style="color:red;">{{ $message }}</p>
						@enderror
					</div>
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="author" name="author" type="text" placeholder="meta author" value="{{ $contact->author }}">
						@error('author')
							<p style="color:red;">{{ $message }}</p>
						@enderror
					</div>
				...
				<div class="tab-pane fade" id="opengraph" role="tabpanel" aria-labelledby="contact-tab">
					...
					{{-- ogimg 600px --}}
					<br>
					<input type="hidden" name="old_picogimg" value="{{ $contact->ogimg }}">


					<label for="short">Картинка ogimg (для соцсетей) - 600x600px</label>
					<div class="mt-0">
						
						<img src="{{ asset( $contact->ogimg ?? 'uploads/not_image.jpg') }}" width="400" alt="" id="showPicogimg">
					</div>
				...
				<div class="tab-pane fade" id="schemaorg" role="tabpanel" aria-labelledby="contact-tab">
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="sschemaDescription" name="schemaDescription" type="text" placeholder="короткое описание статьи" value="{{ $contact->schemaDescription }}">
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="schemaAuthor" name="schemaAuthor" type="text" placeholder="автор статьи" value="{{ $contact->schemaAuthor }}">
						@error('schemaAuthor')
							<p style="color:red;">{{ $message }}</p>
						@enderror
					</div>
					...
					<div class="form-group">
						...
						<input class="form-control form-control-lg" id="schemaPublisher" name="schemaPublisher" type="text" placeholder="название компании" value="{{ $contact->schemaPublisher }}">
